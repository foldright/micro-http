...
// pub struct FnHandler2<F, Args> {
//     f: F,
//     _phantom: PhantomData<fn(Args)>,
// }
// 
// impl<F, Args> FnHandler2<F, Args>
// where
//     F: FnTrait<Args>,
// {
//     fn new(f: F) -> Self {
...
// pub fn handler_fn2<F, Args>(f: F) -> FnHandler2<F, Args>
// where
//     F: FnTrait<Args>,
// {
//     FnHandler2::new(f)
// }
// 
// impl<F, Args> RequestHandler2 for FnHandler2<F, Args>
// where
...
// mod test {
//     use crate::fn_trait::FnTrait;
//     use crate::handler_2::{FnHandler2, RequestHandler2};
// 
//     use http::Method;
// 
//     fn assert_is_fn_handler<H: FnTrait<Args>, Args>(_handler: &FnHandler2<H, Args>) {
//         // no op
//     }
// 
//     fn assert_is_handler<T: RequestHandler2>(_handler: &T) {
//         // no op
//     }
// 
//     #[test]
...
// 
//         let http_handler = FnHandler2::new(get);
